...
def start(message):
	...
	if f == SUDO:
		...
		M = types.InlineKeyboardButton('DEV', url='https://t.me/o_o_v')
		mas.add(G,K)
		mas.add(V)
		mas.add(M)
		...
		me = types.InlineKeyboardButton(text="خيال",url="https://t.me/o_o_v")
		he = types.InlineKeyboardButton(text="خيال",url="https://t.me/o_o_v")
		de = types.InlineKeyboardButton(text="خيال",url="https://t.me/o_o_v")
		ch = types.InlineKeyboardButton(text="▶ قناة البوت ◀",url="https://t.me/TTxxxx")
		rr.add(me,he,de)
		rr.add(ch)
...
def masg(call):
	...
	if call.data =="o_o_v":
		...
		A = types.InlineKeyboardButton(text ="(KKKK44)", callback_data="F1")
		...
		z = types.InlineKeyboardButton(text="(KKKK44)",callback_data="F1")
		bc = types.InlineKeyboardButton(text="رجوع",callback_data="bckkk")
		e.add(f,c,z,d)
		e.add(bc)
		bot.edit_message_text(chat_id=call.message.chat.id,message_id=call.message.message_id,text="اختر من القائمه بالاسفل .",reply_markup=e)
		...
		while True:
			...
			o_o_v = [h1,h2,h3,h4,h5]
			j = random.choice(o_o_v)
			url = "https://t.me/"+j
			headers = {
            "User-Agent": generate_user_agent(),
            "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8",
			...
			if response.text.find('If you have <strong>Telegram</strong>, you can contact <a class="tgme_username_link"')>=0 and j not in ban:
				...
				R = types.InlineKeyboardButton(f'{sk}', callback_data="1x")
				o_o_v = types.InlineKeyboardButton('DEV', url='https://t.me/o_o_v')
				mas.add(A,E,B,R,o_o_v)
				bot.edit_message_text(chat_id=call.message.chat.id,message_id=call.message.message_id,text="ok start",reply_markup=mas)
